# Fakturagenerator - macOS desktop app

Offline macOS desktop build of the Fakturagenerator invoice app.
Everything runs locally: no server, no internet connection needed.

## Install

1. Download `Fakturagenerator-macOS.zip` from the Releases page.
2. Unzip it.
3. Drag `Fakturagenerator.app` into your Applications folder.
...
npx @electron/packager . "Fakturagenerator" --platform=darwin --arch=x64 \
